...
def sierpinski_triangle(order, length, upper_left_x, upper_left_y):
	"""
	:param order: the times that we want to do the recursion.
	:param length: the biggest triangle side length.
	:param upper_left_x: the upper-left-x vertex coordinate of a inverted triangle.
	:param upper_left_y: the upper-left-y vertex coordinate of a inverted triangle.
	...
	if order == 0:
		...
		# Lower
		sierpinski_triangle(order-1, length/2, upper_left_x+length*0.25, upper_left_y+length*0.5*0.866)
